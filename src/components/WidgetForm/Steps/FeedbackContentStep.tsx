...
export function FeedbackContentStep({ 
    feedbackType, 
    onFeedbackRestartRequest, onFeedbackSent}: FeedbackContentStepsProps) {
        ...
        <>
                ...
                <form onSubmit={handleSubmitFeedback} className="my-4 w-full">
                    <textarea 
                        ...
                        focus:ring-brand-500 focus:ring-1 focus:outline-none resize-none scrollbar 
                    ...
                    <footer className="flex gap-2 mt-2">
                        ...
                        <button
                            ...
                            flex justify-center items-center text-sm hover:bg-brand-300 focus:outline-none
